...
def run():
    ...
    plt.legend()
    plt.savefig("{}/training_loss.png".format(folder))
    ...
    _ = save_samples_as_img(-1, samples)
    ...
    plt.savefig("{}/all.png".format(folder))
    ...
    with tf.Session() as sess:
        ...
        gen_samples = sess.run(
            generator(input_z, input_size, n_units=g_hidden_size, reuse=True),
            feed_dict={input_z: sample_z})
    _ = save_samples_as_img(0, [gen_samples], "gen_")
